...
### Data Overview
The project utilises the [AdventureWorks.xlsx workbook](https://github.com/alejandralopezgalan/Adventure-Works-Sales-Analysis/blob/main/assets/data/Project5_AdventureWorks_Database.xlsx), which contains six relational tables:
